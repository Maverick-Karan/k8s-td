...
<pre> ## 🛠️ Build Docker Images Build frontend and backend Docker images: ```bash docker build -t flask-backend ./backend docker build -t express-frontend ./frontend ``` </pre>
